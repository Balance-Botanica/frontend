<script lang="ts">
	...
	const passwordValid = $derived(
		passwordLength && passwordHasUpper && passwordHasLower && passwordHasNumber
	);
		...
		<div class="text-center">
			<div class="mx-auto h-12 w-12 text-green-400">
				<svg fill="currentColor" viewBox="0 0 48 48">
					<path
						fill-rule="evenodd"
						d="M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4 4 12.954 4 24s8.954 20 20 20zm9.707-23.293a1 1 0 00-1.414-1.414L23 28.586l-4.293-4.293a1 1 0 00-1.414 1.414l5 5a1 1 0 001.414 0l10-10z"
						clip-rule="evenodd"
					/>
				</svg>
			</div>
					...
					<div class="mt-2 space-y-1">
						...
						<ul class="space-y-1 text-xs">
							<li class="flex items-center space-x-2">
								...
								<span class={passwordLength ? 'text-green-600' : 'text-gray-600'}
							...
							<li class="flex items-center space-x-2">
								...
								<span class={passwordHasUpper ? 'text-green-600' : 'text-gray-600'}
							...
							<li class="flex items-center space-x-2">
								...
								<span class={passwordHasLower ? 'text-green-600' : 'text-gray-600'}
							...
							<li class="flex items-center space-x-2">
								...
								<span class={passwordHasNumber ? 'text-green-600' : 'text-gray-600'}
									>One number</span
								>
							</li>
						</ul>
