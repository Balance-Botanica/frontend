...
<div class="flex items-center space-x-3">
  <button
    ...
    class="relative inline-flex h-6 w-6 items-center justify-center rounded border-2 transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2"
    style="
