<script lang="ts">
	...
	async function handleVerifyCode() {
		try {
			...
			if (!code) {
				phoneAuthStore.update(state => ({ ...state, error: 'Please enter the verification code' }));
				return;
			}
	...
	{#if currentStep === 'phone'}
		<div class="space-y-4">
			<div class="text-center">
				...
				<p class="text-gray-600 mt-2">Enter your phone number to receive a verification code</p>
			</div>
