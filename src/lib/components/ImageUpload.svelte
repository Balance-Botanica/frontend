...
<div class="space-y-4">
	...
	{:else}
		<!-- Upload Area -->
		<div
			class="border-2 border-dashed border-stroke rounded-lg p-8 text-center transition-colors {dragOver ? 'border-main bg-main/5' : 'hover:border-main/50'}"
		...
		>
			...
			<div class="text-sm text-gray-600 mb-4">
				<label for="file-upload" class="relative cursor-pointer rounded-md font-medium text-main hover:text-main/80">
